...
let nextConditioning = document.getElementsByClassName("next_condition_img")
...
async function getWeatherData() {
    let weatherResponse = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=71dbd840c45b418aa921751582318828q-${city}&days=3`)
